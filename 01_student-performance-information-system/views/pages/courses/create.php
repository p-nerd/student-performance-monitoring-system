...
<div class="rounded-lg border text-card-foreground shadow-sm w-full max-w-md" data-v0-t="card">
    <div class="flex flex-col space-y-1.5 p-6">
        <h3 class="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight">Add new Course</h3>
        <p class="text-sm text-muted-foreground">Fill out the form below to save a new course.</p>
    </div>
    <form class="p-6 space-y-4" method="post" action="/courses">
        <div class="space-y-2">
